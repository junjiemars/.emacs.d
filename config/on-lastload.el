...
(define-key% (current-global-map) "C-x M-l" #'kill-whole-line)
;; Mark
...
(define-key% (current-global-map) "C-M-@" #'mark-sexp)
(define-key% (current-global-map) "C-M-SPC" #'mark-sexp)
(define-key% (current-global-map) "C-M-h" #'mark-defun)
(define-key% (current-global-map) "M-@" #'mark-word)
