...
(defvar *cdb-symbol-alist*
  (list '("$argreg" . nil)
        ...
        '("lm" . "list loaded modules, lmOptions [a Address] [m Pattern | M Pattern]")
        '("lmD" . "displays loaded modules using Debugger Markup Language")
        '("lmv" . "verbose displays the specified loaded modules")
        '("u" . "unassemble, u[u|b] [Range|Address]")
        '("uf" . "unassemble function, uf [Options] Address")
        '("up" . "unassemble from physical memory, up [Range|Address]")
        '("ur" . "unassemble real mode bios, ur [Range|Address]")
        ...
        '("z" . "execute while, Command ; [Processor] z( Expression )"))
