...
(defun define-compile-only-mode ()
  ...
  (compile!
   ...
   (compile-unit% (emacs-home* "config/rs.el") t)
...
(defun declare-prologue-mode! ()
  ...
  (declare-function dup-file (v-home%> "config/ed"))
  (declare-function keyword->string (v-home%> "config/ed"))
  (declare-function string->keyword (v-home%> "config/ed"))
  ...
  (autoload 'dup-file (v-home%> "config/ed"))
  (autoload 'newline* (v-home%> "config/ed") nil t)
  (autoload 'keyword->string (v-home%> "config/ed"))
  (autoload 'string->keyword (v-home%> "config/ed"))
