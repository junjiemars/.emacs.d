    ...
    (when (stringp zip)
      (save-str-to-file
       (concat "@echo off\n"
               ...
               (concat (unless-coding-system% default-file-name-coding-system locale-coding-system
                         (when (eq 'utf-8-unix default-file-name-coding-system)
                           (concat "REM prefer unicode coding system\n"
                                   "chcp 65001\n\n")))
