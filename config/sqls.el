...
(defun on-sql-init! ()
  ...
  (when-fn-sql-show-sqli-buffer%
    (define-key% sql-mode-map "C-c C-z" #'sql-show-sqli-buffer*))
  ;; features' keybindings
  (when-sql-feature%
    (define-key% sql-mode-map "C-c C-l a" #'sql-list-all)
    (define-key% sql-mode-map "C-c C-l c" #'sql-list-code)
    (define-key% sql-mode-map "C-c C-l p" #'sql-desc-plan)
    (define-key% sql-mode-map "C-c C-l t" #'sql-desc-table)
    (define-key% sql-mode-map "C-c C-l x" #'sql-export-query)))
