...
(defun on-mixal-mode-init! ()
  ...
  (define-key% mixal-mode-map "" nil)
  (define-key% mixal-mode-map "o" #'mixal-describe-operation-code)
  (define-key% mixal-mode-map "r" #'mixal*-describe-register)
  (define-key% mixal-mode-map "a" #'mixal*-describe-alphameric)
  (define-key% mixal-mode-map "e" #'mixal*-describe-equipment))
