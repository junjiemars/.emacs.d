...
- non-sudo: @@html:<kbd>@@C-x C-f /ssh:user@remote:/path/to/file@@html:</kbd>@@ or @@html:<kbd>@@C-x C-f /ssh:user:/path/to/file@@html:</kbd>@@,
such as =user@remote= or =user= in .ssh/config entries.

- sudo: @@html:<kbd>@@C-x C-f /ssh:user|sudo:remote:/path/to/file@@html:</kbd>@@,
	such as =user@localhost= or =localhost= if the =user= is a sudoer.

- eshell remote: @@html:<kbd>@@cd /ssh:<user>@<remote>:<dir>@@html:</kbd>@@

- on Windows use =~/.ssh/config=: use =/sshx:= instead,
such as
