...
- non-sudo: @@html:<kbd>@@C-x C-f /ssh:user@remote:/path/to/file@@html:</kbd>@@
or @@html:<kbd>@@C-x C-f /ssh:user:/path/to/file@@html:</kbd>@@,
such as =x@y.z= or =x= in .ssh/config entries.
