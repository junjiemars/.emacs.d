...
2. Check Emacs configurations:
  - @@html:<kbd>@@M-x: system-configuration-options@@html:</kbd>@@
  - @@html:<kbd>@@M-x: system-configuration-features@@html:</kbd>@@
  - @@html:<kbd>@@M-x: features@@html:</kbd>@@
  - @@html:<kbd>@@M-x: load-history@@html:</kbd>@@
  then do =I=.
...
6. Disable the problematic item in =(*self-mod-spec*)=, then do *1*.
