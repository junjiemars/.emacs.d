...
editing, and save it. So, I build Nore Emacs like Ecluid did for
gemometry.

#+REVEAL: split
#+ATTR_HTML: :style text-align:left
Nore Emacs strives to be fast, stable and hacker friendly, which can
be run and with consistent behaviors on wherever Emacs runs.
