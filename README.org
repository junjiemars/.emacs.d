...
how to organize Elisp code perfectly. You can run it on any platform
that Emacs been supported with any mode: GUI or Terminal, even you can
run multiple Emacs instances with different version on the same
