...
#+REVEAL: split
- =:shell-command-switch= switch of shell's command line
...
- =:desktop-restore-frames @@html:<kbd>@@C-h-v desktop-restore-frames@@html:</kbd>@@
- =:allowed= =t= enabled, =nil= disabled
...
- @@html:<kbd>@@C-c C-M-h@@html:</kbd>@@: =mark-defun@=
...
- toggle comment the current line or region: @@html:<kbd>@@C-x
  M-;@@html:</kbd>@@. =toggle-comment= more better
  =comment-line=.
