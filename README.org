...
- display non-unicode encoding directory name or file name
- insert non unicode encoding directory
- compress the files that encoded with ~locale-coding-system~
