...
#+REVAL: split
- kill /word/: @@html:<kbd>@@M-d@@html:</kbd>@@ or @@html:<kbd>@@C-c k
  w@@html:</kbd>@@, include the word that current point located.
- kill /symbol/: @@html:<kbd>@@C-<backspace>@@html:</kbd>@@ or
  @@html:<kbd>@@C-c k s@@html:</kbd>@@, include the symbol that
  current point located.
