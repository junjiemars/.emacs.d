...
- copy to clipboard: select region then @@html:<kbd>@@M-|
  pbcopy@@html:</kbd>@@
- paste from clipboard: @@html:<kbd>@@C-u M-| pbpaste@@html:</kbd>@@

On Linux
- copy to clipboard: select region then @@html:<kbd>@@M-| xsel
  -i@@html:</kbd>@@
- paste from clipboard: @@html:<kbd>@@Cu M-| xsel -o@@html:</kbd>@@
