...
[[file:config/on-dired-autoload.el][on-dired-autoload.el]]
...
[[file:config/on-grep-autoload.el][on-grep-autoload.el]]
...
Same behavior from Emacs22+
- Jump to tags: @@html:<kbd>@@M.@@html:</kbd>@@
- Jump back from tags: @@html:<kbd>@@M,@@html:</kbd>@@
