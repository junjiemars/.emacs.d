...
#+ATTR_HTML: :style text-align:left
The theme's spec locate in =(*self-paths* :get :env-spec)= by default.
...
#+ATTR_HTML: :style text-align:left
The frame's spec locate in =(*self-env-spec* :get :frame)= by
...
#+ATTR_HTML: :style text-align:left
The shell spec locate in =(*self-env-spec* :get :shell)= by
default.
...
#+ATTR_HTML: :style text-align:left
The socks spec locate in =(*self-env-spec* :get :socks)= by
default.
...
point. If prefix N is non nil, set mark away from point then forward
