...
- =χ%= macro =x= will be expanded at compile time, such as =v-home%=
- =χ!= function or macro =x= has side-effects, such as =v-home!=
- =χ@= position related functions, such as =mark-word@= and
  =mark-sexp@=
- =χ*-y= extension of function =y= of package =x=, such as =vc*-dir=
