...
Using Emacs's builtin themes /tango-dark/ @@html:<kbd>@@M x customize-themes@@html:</kbd>@@ [[https://github.com/junjiemars/images/blob/master/.emacs.d/tango-dark-theme-on-windows.PNG][screenshot: tango-dark]]:
...
[[https://github.com/junjiemars/images/blob/master/.emacs.d/cjk-on-darwin.png][screenshot: CJK]]
